...
import { getEmail, getPhoneNumber, getUserName, getfullname ,getUserID ,getCredits} from '../sign-in/auth';
            ...
            <div className="p-2 text-center">
              ...
              <table className="my-3 text-xl mx-auto">
                <tbody>
                  ...
                  <tr>
                    <td className="px-2 py-2 text-left text-gray-500 font-semibold">Credits</td>
                    <td className="px-2 py-2 text-left">{credits}</td>
                  </tr>
