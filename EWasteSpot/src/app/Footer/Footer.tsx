    ...
    <footer className="footer projects shadow-2xl">
      ...
      />
        <div className="container">
          <div className="footer-brand">
            ...
            EWaste-Spot: Transforming E-Waste Management. Find E-waste facilities effortlessly with our platform. Your key to responsible recycling and sustainability.
            </p>
          ...
          <ul className="footer-list">
            <li>
              <p className="footer-list-title">E-WasteSpot</p>
            </li>
            <li>
          ...
          <ul className="footer-list">
            ...
            <li className="footer-item">
              ...
              <Link
                target="_blank"
                rel="noopener noreferrer"
                href="mailto:contact@ewastespot.com"
                className="contact-link"
              >
                contact@ewastespot.com{" "}
              </Link>
            </li>
            <li className="footer-item">
      ...
      <div className="footer-bottom">
        ...
        <p className="copyright">
            &copy; 2024 EWaste-Spot | All Rights Reserved by{" "}
